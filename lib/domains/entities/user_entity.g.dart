...
extension GetUserEntityCollection on Isar {
  IsarCollection<UserEntity> get userEntities => this.collection();
}
...
void _userEntitySerialize(
  ...
  writer.writeString(offsets[1], object.homeTown.name);
  writer.writeBool(offsets[2], object.isDrinkingAlcohol);
...
UserEntity _userEntityDeserialize(
  ...
  object.homeTown =
      _UserEntityhomeTownValueEnumMap[reader.readStringOrNull(offsets[1])] ??
          HomeTown.Tokyo;
  object.id = id;
  object.isDrinkingAlcohol = reader.readBool(offsets[2]);
